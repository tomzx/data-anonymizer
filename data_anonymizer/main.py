...
argument_parser.add_argument("output", help="Path where to store the anonymized data")
...
argument_parser.add_argument(
    "--feature-min-max-scale", nargs="+", help="Feature to scale between 0 and 1"
)
argument_parser.add_argument("--feature-remove", nargs="+", help="Feature to remove")
argument_parser.add_argument(
    "--feature-round",
    nargs="+",
...
if args.feature_categorize:
    ...
    df[args.feature_categorize] = ordinal_encoder.transform(df[args.feature_categorize])
